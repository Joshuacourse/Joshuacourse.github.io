...
NLP_positive_business_not_filter=read.csv("NLP_positive_business_not_filter.csv",stringsAsFactors = F)
...
# remove terms that are stop words or occur fewer than 4 times:
